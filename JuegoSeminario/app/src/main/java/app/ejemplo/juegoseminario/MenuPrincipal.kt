...
class MenuPrincipal : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // inicio el nombre del usuario
        if (inicioUser==true) {
            inicioUser=false // asegura que el codigo solo se ejecuta cuando se abre la app por primea vez
            ...
            dialog.setOnShowListener {
                ...
                input.addTextChangedListener(object : TextWatcher {
                    override fun afterTextChanged(s: Editable?) {
                        ...
                        button.isEnabled = nombre.length >= 5 // Habilitar o deshabilitar el botón "Aceptar" según la longitud del nombre
                    }
